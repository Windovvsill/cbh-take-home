 ...
 */
const pipe = (...fns) => start => fns.reduce((param, cur) => cur(param), start);
 ...
 */
const ensureCandidateType = candidate => typeof candidate === "string" ? candidate : JSON.stringify(candidate);
